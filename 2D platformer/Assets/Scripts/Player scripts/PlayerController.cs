...
/*    public void OnMove(InputAction.CallbackContext context) 
    ...
    public void ApplyPowerUp(PowerUps powerUp)
    {
        ...
        speedBoostCoroutine = StartCoroutine(SpeedBoostCoroutine(powerUp.speedBoost, powerUp.duration));
    }

    private IEnumerator SpeedBoostCoroutine(float boostAmount, float duration)
    {
        float originalMultiplier = speedBoostMultiplier;
        speedBoostMultiplier = (walkSpeed + boostAmount) / walkSpeed;

        Debug.Log("Speed boost activated");

        yield return new WaitForSeconds(duration);
        speedBoostMultiplier = originalMultiplier;
